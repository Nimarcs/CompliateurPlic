...
public class Egal extends Expression {
    ...
    public void verifier() throws ErreurSemantique {
        if (!operande1.getType().equals("entier")) throw new ErreurSemantique("operande 1 ne peut pas faire parti d'une comparaision, n'est pas de type entier ("+ operande1+')');
        if (!operande2.getType().equals("entier")) throw new ErreurSemantique("operande 2 ne peut pas faire parti d'une comparaision, n'est pas de type entier ("+ operande2+')');
        operande1.verifier();
        operande2.verifier();
    }
